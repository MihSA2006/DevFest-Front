    ...
    const sectors = [
        {
            ...
            description: "Agriculture, pêche, exploitation forestière et extraction minière",
            icon: "🌾"
        },
        {
            id: 2,
    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-12 flex flex-col justify-center items-center" style={{ height: '100vh', width: '100vw' }}>
            ...
            <div className='absolute top-5 left-5'>
                <h1 className='text-2xl lg:text-2xl font-bold mb-4 leading-tight text-gray-500'>Etape 1 / 5</h1>
            </div>
                            ...
                            <div className="flex h-full" style={{ width: '100%', height: '250px' }}>
                                ...
                                <div className="w-[50%] relative overflow-hidden">
                                    <div
                                        ...
                                        style={{ background: 'linear-gradient(90deg, transparent 0%, rgba(29, 55, 63, 0.2) 100%)', clipPath: 'polygon(0 0, 100% 0, 75% 100%, 0% 100%)' }}
                                    />
                                    <img
                                        src={sector.image}
                                        alt={sector.title}
                                    ...
                                    >
                                        {
                                            sector.id === 1 ? <GiVanillaFlower /> : sector.id === 2 ? <FaShip /> : <GiHandBag />
                                        }
                                    </div>
                                </div>
